...
module.exports = {
    ...
    SESSION: process.env.THAKKU_SESSION === undefined ? '' : process.env.THAKKU_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/CpIDTku.jpeg' : process.env.GAN_IMAGE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By ThakkuMol' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '~*----𝚃𝚑𝚊𝚔𝚔𝚞𝚖𝚘𝚕----*~' : process.env.BOT_NAME,
